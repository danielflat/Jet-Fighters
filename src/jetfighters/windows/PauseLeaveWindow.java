 ...
 * @version 13.07.22
 */
public class PauseLeaveWindow extends AbstractWindow {
    ...
    /**
     * creates the pause leave window
     *
     * @param window the JFrame window as a reference
     */
    public PauseLeaveWindow(Window window) {
        super(window);
     ...
     */
    private void setupPauseLeaveWindow() {
    ...
    private void setupImages() {
        ...
        try {
            ...
            descriptionImage = new ImageIcon(ImageIO.read(Objects.requireNonNull(classLoader.getResourceAsStream(
                    "fonts/PauseLeave_description.png"))));
            ...
            System.err.println("Couldn't load images in PauseLeaveWindow correctly:");
            e.printStackTrace();
        }
    }
    ...
    private void setupLabels() {
        ...
        setupLabel(descriptionLabel, 200, 275, descriptionImage);
    }
    ...
    private void setupKeyBindings() {
        setupKeyStroke("Yes", "1", () -> window.updateMenuState(MenuState.Menu));
        setupKeyStroke("No", "2", () -> window.updateMenuState(MenuState.Pause));
    }
